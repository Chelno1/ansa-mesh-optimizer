...
class SimpleParameterReplacementStrategy(ParameterReplacementStrategy):
    ...
    def replace_parameters(self, file_path: str, params: Dict[str, float]) -> str:
        ...
        try:
            ...
            # 执行简单参数替换
            updated_content = self._perform_simple_parameters_replacement(content, params)

            # 生成新文件路径
            updated_file_path = self._generate_output_path(file_path, "_simple_parameters_updated")
    ...
    def _perform_simple_parameters_replacement(self, content: str, params: Dict[str, float]) -> str:
...
class ParameterReplacementManager:
    ...
    def register_strategy(self, strategy: ParameterReplacementStrategy) -> None:
        ...
        if not isinstance(strategy, ParameterReplacementStrategy):
            raise ValueError("Strategy must be an instance of ParameterReplacementStrategy")
...
#用于mesh_evaluator调用
format_mpar_parameter_value = SimpleParameterReplacementStrategy()._format_mpar_parameter_value