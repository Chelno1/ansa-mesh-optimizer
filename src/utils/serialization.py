...
def validate_file_path(
    file_path: Union[str, Path], must_exist: bool = True, create_dir: bool = False
) -> Path:
    """
    验证文件路径
...
def save_json_config(
    config: Dict[str, Any], config_file: Union[str, Path], backup: bool = True
) -> None:
    """
    安全保存JSON配置文件
...
if __name__ == "__main__":
    ...
    test_data = {
        ...
        "int": np.int32(42),
        "nested": {"values": np.array([0.1, 0.2, 0.3])},
    }
