...
class EvolutionLoop:
    ...
    def __init__(
        self, evolution_engine: EvolutionEngine, evaluator, param_names: List[str]
    ):
        """
        初始化进化循环管理器
    ...
    def run_evolution(
        ...
        for generation in range(max_generations):
            ...
            if self.evolution_engine.should_restart(generation):
                ...
                population = self.evolution_engine.restart_population(
    ...
    def _update_best_ever_individual(self) -> None:
        ...
        if (
            ...
            and (
                ...
                or self.best_individual.fitness < self.best_ever_fitness
            )
        ):
    ...
    def _log_progress(self, generation: int, total_evaluations: int) -> None:
        ...
        """
        best_fitness = (
            self.best_individual.fitness if self.best_individual else float("inf")
        )
