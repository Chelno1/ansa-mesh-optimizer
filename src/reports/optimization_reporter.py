...
class OptimizationReporter:
    ...
    def generate_optimization_report(self, 
                                   ...
                                   early_stopping_info: Optional[Dict[str, Any]] = None) -> str:
        """
        生成完整的优化报告
        ...
        try:
            ...
            self._write_text_report(report_file, result, optimization_history, 
                                  config, cache_stats, early_stopping_info)
            
            # 生成数据文件
            self._save_optimization_data(result, optimization_history, config, param_space)
    ...
    def _write_text_report(self, 
                          ...
                          config: Any,
                          cache_stats: Optional[Dict[str, Any]] = None,
                          early_stopping_info: Optional[Dict[str, Any]] = None) -> None:
        """写入文本报告"""
        with open(report_file, 'w', encoding='utf-8') as f:
            ...
            if optimization_history:
                ...
                # 计算改进次数
                improvements = sum(1 for i in range(1, len(results)) if results[i] < results[i-1])
    ...
    def _save_optimization_data(self, 
        ...
        try:
            ...
            with open(best_params_file, 'w', encoding='utf-8') as f:
                json.dump(result.get('best_params', {}), f, indent=2, ensure_ascii=False)
    ...
    def generate_performance_summary(self, 
        ...
        try:
            ...
            summary.update({
                ...
                'improvement_rate': len(improvements) / len(results) if results else 0,
                'improvement_iterations': improvements,
                'convergence_iteration': improvements[-1] if improvements else len(results) - 1
            })
    ...
    def export_optimization_data(self, 
        ...
        if export_format.lower() == 'json':
            ...
            export_data = {
                ...
                'performance_summary': self.generate_performance_summary(optimization_history),
            ...
            try:
                ...
                return self.export_optimization_data(result, optimization_history, 'json')
