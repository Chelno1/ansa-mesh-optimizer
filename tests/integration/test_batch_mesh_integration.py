...
class TestBatchMeshIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.runner = AnsaBatchMeshRunner(
            script_dir=Path(self.temp_dir), config=self.config
        )
    ...
    def test_error_handling(self):
        """测试错误处理"""
        # 无效参数测试
        invalid_params = {"distortion_distance": -1.0}  # 无效的负值
    ...
    def test_quality_thresholds(self):
        """测试质量阈值"""
        custom_thresholds = {"min_element_length": 1.0, "max_element_length": 5.0}
