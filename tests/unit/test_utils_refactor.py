...
from src.utils import (
    safe_json_serialize as utils_safe_json_serialize,
    format_execution_time as utils_format_execution_time,
    normalize_params as utils_normalize_params
)
...
class TestSerialization:
    ...
    def test_safe_json_serialize_numpy_types(self):
        ...
        data = {
            ...
            'np_int': np.int32(42),
            'nested': {
                'np_values': np.array([0.1, 0.2, 0.3])
            }
        }
...
class TestUtils:
    ...
    def test_extract_numbers_from_text(self):
        ...
        # 测试整数模式
        integers = extract_numbers_from_text("有 3 个苹果和 5 个橙子", pattern='integer')
...
class TestUnifiedInterface:
    ...
    def test_backward_compatibility(self):
        ...
        # 确保原有的导入方式仍然可用
        try:
            from src.utils import safe_json_serialize
